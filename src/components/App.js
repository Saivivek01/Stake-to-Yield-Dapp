...
class App extends Component {
    ...
    async loadWeb3() {
        if(window.ethereum) {
            ...
            window.alert('No ethereum browser detected! Check out MetamMask')
        }
    }
    ...
    // two functions stake & unstake
    // leverage our decentralBank contract - deposit tokens ans unstaking
